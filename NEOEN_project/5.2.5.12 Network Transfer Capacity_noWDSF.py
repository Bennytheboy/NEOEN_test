...
Q_max_setpoint = 60  # CHANG: change this value according to your suggestion from 5.2.5.1 Reactive Power Capability
...
for i in range(0, len(Fault_Equipment_Start)):
    ...
    if Fault_Equipment_Type[i] == 'LN':  # disconnect line
        ...
        ierr = psspy.branch_chng_3(21253, 49031, r"""1""", [0, _i, _i, _i, _i, _i],
