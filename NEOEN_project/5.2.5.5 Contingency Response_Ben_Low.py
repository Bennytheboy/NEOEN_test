...
# Set Simulation Path.
LoadScenario = "SummerLowLoad"
ClauseName = "5.2.5.5 Contingency Response_0.001"
ProgramPath = "C:/NEOEN/P_SimulationScripts/"
GridInfoPath = "C:/NEOEN/NEM_files/"
HuaweiModelPath = "C:/NEOEN/Huawei_models/"
OutputFilePath = ProgramPath + ClauseName+"Simulation.outx"
...
for i in range(0, len(Branch_Outage_List_Start)):
    for fault_type in range(1, 5):
        ...
        p_data_101 = numpy.array(chandata[7])
        q_data_101 = numpy.array(chandata[8])
        p_data_102 = numpy.array(chandata[9])
        q_data_102 = numpy.array(chandata[10])
        p_data_103 = numpy.array(chandata[11])
        q_data_103 = numpy.array(chandata[12])
        p_data_104 = numpy.array(chandata[13])
        q_data_104 = numpy.array(chandata[14])
        ...
        CurrentFig, CurrentAx = plt.subplots(2, 2, sharex=False, figsize=(20, 15));
        CurrentAx[0][0].plot(chandata['time'], 108*p_data_101);
        CurrentAx[1][0].plot(chandata['time'], 108*p_data_102);
        CurrentAx[0][1].plot(chandata['time'], 108*p_data_103);
        CurrentAx[1][1].plot(chandata['time'], 108*p_data_104);
        ...
        CurrentFig, CurrentAx = plt.subplots(2, 2, sharex=False, figsize=(20, 15));
        CurrentAx[0][0].plot(chandata['time'], 108*q_data_101);
        CurrentAx[1][0].plot(chandata['time'], 108*q_data_101);
        CurrentAx[0][1].plot(chandata['time'], 108*q_data_101);
        CurrentAx[1][1].plot(chandata['time'], 108*q_data_101);
