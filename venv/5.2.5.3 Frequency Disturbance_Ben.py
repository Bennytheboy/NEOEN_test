...
ClauseName = "5.2.5.3 Frequency Response"
...
Disturbance_Load_Amount = numpy.arange(10, 600, 50)
...
##        value_bottom=45
    ...
    CurrentAx[0][1].set_ylim([-5, 150])
    CurrentAx[1][1].set_ylim([-70, 70])
    ...
    CurrentAx[0][1].set_title(r"""RVSF Active Power Output""")
    CurrentAx[1][1].set_title(r"""RVSF Reactive Power Output""")
