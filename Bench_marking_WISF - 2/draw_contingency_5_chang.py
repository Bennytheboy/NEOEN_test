...
if plot_fault == 1:
    with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/WISF/R_Results_2/BenchmarkingThreePhase/' + "ThreePhasecontingency_PSSE Fault_1.csv", 'rb') as t_file:
        FileData = csv.reader(t_file)
        FileData = list(FileData)
if plot_fault == 3:
...
with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/WISF/chang_PSCAD/' + 'three_phase_fault.csv', 'rb') as t_file:
    FileData = csv.reader(t_file)
    FileData = list(FileData)
...
CurrentAx[0][0].set_xlim([2,10])
CurrentAx[1][0].set_xlim([2,10])
CurrentAx[2][0].set_xlim([2,10])
CurrentAx[0][1].set_xlim([2,10])
CurrentAx[1][1].set_xlim([2,10])
CurrentAx[2][1].set_xlim([2,10])
...
save_figure_name = 'F:/PosDoc Projects/11_Industrial Projects/HuaWei/WISF/R_Results_2/5.2.5.5_' +  fault_name+'_01_new.png'
