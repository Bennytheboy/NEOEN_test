...
OutputFilePath=ProgramPath+"SimulationOutput4_pb_1.outx"
...
# psspy.case(r"""F:\PosDoc Projects\11_Industrial Projects\HuaWei\WISF\D_SimplifiedSystem\WISF_1.05_pb_2.sav""")
# psspy.dyre_new([1,1,1,1],r"""F:\PosDoc Projects\11_Industrial Projects\HuaWei\WISF\D_SimplifiedSystem\WISF_1.05_pb_2.dyr""","","","")
# psspy.resq(r"""F:\PosDoc Projects\11_Industrial Projects\HuaWei\WISF\D_SimplifiedSystem\WISF_1.05_pb_2.seq""")
# psspy.addmodellibrary(r"""F:\PosDoc Projects\11_Industrial Projects\HuaWei\WISF\huawei dlls 55ktl\HWS2000_psse34.dll""")
# psspy.addmodellibrary(r"""F:\PosDoc Projects\11_Industrial Projects\HuaWei\WISF\huawei dlls 55ktl\MOD_GPM_PPC_V13_34.dll""")
# psspy.addmodellibrary(r"""F:\PosDoc Projects\11_Industrial Projects\HuaWei\WISF\huawei dlls 55ktl\MOD_GPM_SB_V7.dll""")
...
#
# psspy.bus_frequency_channel([1, 500], r"""System frequency_1""")
...
# psspy.bus_frequency_channel([8, 1000], r"""System frequency_10""")
# psspy.plmod_status(1000,r"""1""",1,0)
# # psspy.plmod_status(1000,r"""1""",6,0)
#
#
...
CurrentAx[1][0].plot(chandata['time'][0:min(len(chandata[2])-1,t_terminate_point+50)],50*(1+freq_data[0:min(len(chandata[8])-1,t_terminate_point+50)]));
