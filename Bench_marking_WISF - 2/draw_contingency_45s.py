...
plot_fault = 3  # 1=threephase 2=single pahse 3=phase-phase 4=phase-phase-ground
if plot_fault == 1:
...
if plot_fault == 1:
    with open(
            'F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/Test04_3Phase75/Test04_3phase75_01.txt') as f1:
        lines1 = f1.readlines()
...
if plot_fault == 2:
    with open(
            'F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/single_phase/Test08_sPhase75/Test08_sPhase75_01.txt') as f1:
        lines1 = f1.readlines()
        time_pscad = [float(line.split()[0]) for line in lines1]
        F_sys_pscad = [float(line.split()[1]) for line in lines1]
        U_poc_pscad = [float(line.split()[2]) for line in lines1]
...
if plot_fault == 3:
    with open(
            'F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/2phase/Test04_2Phase75/Test04_2phase75_01.txt') as f1:
        lines1 = f1.readlines()
        time_pscad = [float(line.split()[0]) for line in lines1]
        F_sys_pscad = [float(line.split()[1]) for line in lines1]
        U_poc_pscad = [float(line.split()[2]) for line in lines1]
...
if plot_fault == 4:
    with open(
            'F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/2phasetoground/Test04_2PhaseGround75/Test04_2phaseGround75_01.txt') as f1:
        lines1 = f1.readlines()
        time_pscad = [float(line.split()[0]) for line in lines1]
        F_sys_pscad = [float(line.split()[1]) for line in lines1]
        U_poc_pscad = [float(line.split()[2]) for line in lines1]
...
if plot_fault ==1:
    with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/three_phase/Test04_3Phase75/Test04_3phase75_02.txt') as f2:
        lines2 = f2.readlines()
        Q_poc_pscad = [float(line.split()[9]) for line in lines2]
if plot_fault ==2:
    with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/single_phase/Test08_sPhase75/Test08_sPhase75_02.txt') as f2:
        lines2 = f2.readlines()
        Q_poc_pscad = [float(line.split()[9]) for line in lines2]
if plot_fault==3:
    with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/2phase/Test04_2Phase75/Test04_2phase75_02.txt') as f2:
        lines2 = f2.readlines()
        Q_poc_pscad = [float(line.split()[9]) for line in lines2]
if plot_fault ==4:
    with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/2phasetoground/Test04_2PhaseGround75/Test04_2phaseGround75_02.txt') as f2:
        lines2 = f2.readlines()
        Q_poc_pscad = [float(line.split()[9]) for line in lines2]

if plot_fault==1:
    with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/three_phase/Test04_3Phase75/Test04_3phase75_03.txt') as f3:
        lines3 = f3.readlines()
        P_poc_pscad = [float(line.split()[2]) for line in lines3]
if plot_fault==2:
    with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/single_phase/Test08_sPhase75/Test08_sPhase75_03.txt') as f3:
        lines3 = f3.readlines()
        P_poc_pscad = [float(line.split()[2]) for line in lines3]
if plot_fault==3:
    with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/2phase/Test04_2Phase75/Test04_2phase75_03.txt') as f3:
        lines3 = f3.readlines()
        P_poc_pscad = [float(line.split()[2]) for line in lines3]
if plot_fault ==4:
    with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/2phasetoground/Test04_2PhaseGround75/Test04_2phaseGround75_03.txt') as f3:
        lines3 = f3.readlines()
        P_poc_pscad = [float(line.split()[2]) for line in lines3]
...
CurrentAx[0][0].set_xlim([45, 50])
CurrentAx[1][0].set_xlim([45, 50])
CurrentAx[2][0].set_xlim([45, 50])
CurrentAx[0][1].set_xlim([45, 50])
CurrentAx[1][1].set_xlim([45, 50])
CurrentAx[2][1].set_xlim([45, 50])

CurrentAx[0][0].set_ylim([0.8, 1.15])
CurrentAx[0][1].set_ylim([0.6, 2.0])
CurrentAx[1][0].set_ylim([60, 110])
CurrentAx[1][1].set_ylim([60, 110])
...
save_figure_name = 'F:/PosDoc Projects/11_Industrial Projects/HuaWei/WISF/R_Results_2/rev1/5.2.5.5_' + fault_name+'_04.png'
CurrentFig.savefig(save_figure_name, format='png', dpi=150, bbox_inches='tight')
plt.close(CurrentFig)
