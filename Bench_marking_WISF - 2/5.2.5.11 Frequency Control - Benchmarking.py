...
psspy.change_plmod_con(1000,r"""1""",r"""GENCLS""",1, 0.12)
...
psspy.load_data_3(1000,r"""1""",[_i,_i,_i,_i,_i],[ 560,_f,_f,_f,_f,_f])
psspy.run(0, 15, 10000,  20, 0)
psspy.load_data_3(1000,r"""1""",[_i,_i,_i,_i,_i],[ 980,_f,_f,_f,_f,_f])
...
CurrentAx[2][0].plot(chandata['time'][0:min(len(chandata[2])-1,t_terminate_point+50)],chandata[6][0:min(len(chandata[4])-1,t_terminate_point+50)]);
CurrentAx[2][1].plot(chandata['time'][0:min(len(chandata[2])-1,t_terminate_point+50)],chandata[7][0:min(len(chandata[5])-1,t_terminate_point+50)]);
...
CurrentAx[2][0].set_ylabel(r"""Power/MW""")
CurrentAx[2][1].set_ylabel(r"""Power/MVar""")
...
CurrentAx[2][0].legend([r"""inverter P Output"""])
CurrentAx[2][1].legend([r"""inverter Q Output"""])
