...
with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/Test05_VD/Test05_VD_01.txt') as f1:
    lines1 = f1.readlines()
...
with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/Test05_VD/Test05_VD_02.txt') as f2:
    lines2 = f2.readlines()
    Q_poc_pscad = [float(line.split()[9]) for line in lines2]
with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/Test05_VD/Test05_VD_03.txt') as f3:
    lines3 = f3.readlines()
...
CurrentAx[0][1].set_ylim([0.6, 1.4])
...
save_figure_name = 'F:/PosDoc Projects/11_Industrial Projects/HuaWei/WISF/R_Results_2/' + '5.2.5.4_Voltage_dist_BM_pscad/'+str(t_start)+'_.png'
