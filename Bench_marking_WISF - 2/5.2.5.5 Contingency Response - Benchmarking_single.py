...
if LoadScenario == "SimplifiedSystem":
    file_name = "WISF_ADD_1.05"
# start simulation
OutputFilePath = ProgramPath + "SimulationOutput_contingency.outx"
TimeShift = 0
...
psspy.voltage_channel([8, -1, -1, 400], r"""400 Voltage Mag.""")
# psspy.bus_frequency_channel([8, 600], r"""System frequency_8""")
# psspy.bus_frequency_channel([9, 800], r"""System frequency_9""")
# psspy.bus_frequency_channel([10, 1000], r"""System frequency_10""")
...
for fault_type in [4]:
    ...
    for i in range(0, 4):
        ...
        if i == 2:
            psspy.branch_chng_3(400, 950, r"""1""", [_i, _i, _i, _i, _i, _i],
                                [_f, 0.204585 * 1.00, _f, _f, _f, _f, _f, _f, _f, _f, _f, _f],
                                [_f, _f, _f, _f, _f, _f, _f, _f, _f, _f, _f, _f], "")
        ...
        if fault_type == 4:  # phase to phase to ground
            psspy.dist_scmu_fault_2([0, 0, 2, 400, _i], [0.000001, 0.0, 0.000001, 0.0])
