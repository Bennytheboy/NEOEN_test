...
test_name = 'Active_Power_control'
# psse_csv_name ='5.2.5.14_active PowerPSSE Active Power Setpoint'+'.csv'
# pscad_csv_name = ''+'.csv'
time_psse = []
P_inv_psse = []
Q_inv_psse = []
...
with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/WISF/R_Results_2/BM_active Power_control/' + 'PSSE Active Power Setpoint.csv', 'rb') as t_file:
...
with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/Test06_AP/Test06_ActivePower_01.txt') as f1:
    lines1 = f1.readlines()
...
with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/Test06_AP/Test06_ActivePower_02.txt') as f2:
    lines2 = f2.readlines()
    Q_poc_pscad = [float(line.split()[9]) for line in lines2]
with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/Test06_AP/Test06_ActivePower_03.txt') as f3:
    lines3 = f3.readlines()
...
CurrentAx[0][0].set_xlim(left=3)
CurrentAx[1][0].set_xlim(left=3)
CurrentAx[2][0].set_xlim(left=3)
CurrentAx[0][1].set_xlim(left=3)
