...
S = 100.00   # in MVA
ActivePowerSetpoint = 0.44  # in p.u
ReactivePowerSetpoint = 0.05  # in P.u.
...
psspy.fact()
psspy.tysl(1)
psspy.change_plmod_con(600, r"""1""", r"""GENCLS""", 1, 0.001)

# start simulation
psspy.strt_2([0, 0], OutputFilePath)
psspy.run(0, 1, 1000, 1, 0)
psspy.change_plmod_var(101,r"""1""",r"""GPMPPC""",11, 4*ActivePowerSetpoint*S)
psspy.change_plmod_var(101,r"""1""",r"""GPMPPC""",69, 1.05)
psspy.change_plmod_var(101,r"""1""",r"""GPMPPC""",12, 4*ReactivePowerSetpoint*S)
psspy.run(0, 5, 1000, 1, 0)
psspy.change_plmod_var(101,r"""1""",r"""GPMPPC""",11, 86.4)
psspy.change_plmod_var(101,r"""1""",r"""GPMPPC""",69, 1.05)
psspy.change_plmod_var(101,r"""1""",r"""GPMPPC""",12, 43.2)
