...
ClauseName = "5.2.5.14_RVC"
ProgramPath = "F:/NEOEN/P_SimulationScripts/"
GridInfoPath = "F:/NEOEN/NEM_files/" + LoadScenario + "/"
#HuaweiModelPath = "F:/NEOEN/"
#OutputFilePath = ProgramPath + "VS_SimulationOutput.outx"
FigurePath = "F:/NEOEN/"


if LoadScenario == 'SummerLowLoad':
    FileName = 'SummerLo-20171226-043047-34-SystemNormal_all_bus_DDSF'
...
Event_Name = [];
P_setpoint = [0, 100, 50,
              0]  # CHANG: change this value according to your suggestion from 5.2.5.1 Reactive Power Capability
Q_max_setpoint = [0, 40, 40,
                  40];  # CHANG: sample : change this value according to your suggestion from 5.2.5.1 Reactive Power Capability
Q_min_setpoint = [0, -40, -40,
                  -40];  # CHANG: sample :change this value according to your suggestion from 5.2.5.1 Reactive Power Capability
...
ResultFile = open(FigurePath + 'VoltageMonitor_low.csv', 'w');
...
ResultFile = open(FigurePath + 'P_MW_Monitor_low.csv', 'w');
...
ResultFile = open(FigurePath + 'S_Pct_Monitor_low.csv', 'w');
ResultFile.write('Event \ Branch ' + ',')
for i in range(0, len(Power_Flow_Monitor_Start)):
    if Power_Flow_Monitor_Type[i] == 'SH' or Power_Flow_Monitor_Type[i] == 'QL' or Power_Flow_Monitor_Type[i] == 'GE':
        break;
