...
ClauseName = "5.2.5.5 Contingency Response_2"
ProgramPath = "F:/NEOEN/"
GridInfoPath = "F:/NEOEN/"
...
ierr = psspy.addmodellibrary(GridInfoPath + 'dsusr2017.dll')
...
for i in range(0, len(Branch_Outage_List_Start)):
    for fault_type in range(1, 5):
        ...
        CurrentAx[0][1].set_ylim([-5, 130])
        CurrentAx[1][1].set_ylim([-80, 80])
        ...
        CurrentAx[1][0].set_title(r"""Metz SF PoC Medium Voltage""")
        CurrentAx[0][1].set_title(r"""Metz SF Active Power Output""")
        CurrentAx[1][1].set_title(r"""Metz SF Reactive Power Output""")
