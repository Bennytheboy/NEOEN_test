...
#
# psspy.change_con(var_ppc_conp+25,0.85)
# psspy.change_con(var_ppc_conp+26,1.15)
#
...
numpy.savetxt(GraphPath+TestName+'PSSE Voltage Disturbance.csv', numpy.transpose([TIME,FREQ,V_INV,V_POC,P_INV,P_POC,Q_INV,Q_POC]), delimiter=',')
