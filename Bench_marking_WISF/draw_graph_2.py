...
for t in range(4, 90, 5):
    ...
    CurrentAx[0][0].set_xlim([t, t + 5])
    CurrentAx[1][0].set_xlim([t, t + 5])
    CurrentAx[2][0].set_xlim([t, t + 5])
    CurrentAx[0][1].set_xlim([t, t + 5])
    CurrentAx[1][1].set_xlim([t, t + 5])
    CurrentAx[2][1].set_xlim([t, t + 5])
    ...
    save_figure_name = GraphPath + str(t) + '.png'
