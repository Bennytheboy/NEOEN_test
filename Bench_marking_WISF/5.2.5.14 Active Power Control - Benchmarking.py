...
TestName ="5.2.5.14_active Power"
...
numpy.savetxt(GraphPath+ TestName +'PSSE Active Power Setpoint.csv', numpy.transpose([TIME,FREQ,V_INV,V_POC,P_INV,P_POC,Q_INV,Q_POC,V_SET,P_SET]), delimiter=',')
