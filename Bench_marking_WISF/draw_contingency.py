...
with open('F:/PosDoc Projects/11_Industrial Projects/HuaWei/PSCAD_DATA/Test01_3Phase0/Test01_3phase0_02.txt') as f2:
    lines2 = f2.readlines()
    Q_poc_pscad = [float(line.split()[8]) for line in lines2]
...
save_figure_name = 'F:/PosDoc Projects/11_Industrial Projects/HuaWei/WISF/R_Results/Benchmarking/' + '5.2.5.5_contingencyPSSE Fault_1.png'
CurrentFig.savefig(save_figure_name, format='png', dpi=150, bbox_inches='tight')
plt.close(CurrentFig)
