...
CurrentFig, CurrentAx = plt.subplots(2, 2, sharex=False, figsize=(20, 20))
...
CurrentAx[0][0].plot(t_TIME_PSSE, t_V_POC_PSSE)
CurrentAx[0][1].plot(t_TIME_PSSE, t_P_POC_PSSE)
# CurrentAx[1][1].plot(t_TIME_PSSE, t_P_SET_PSSE,color='green',linestyle='--')
CurrentAx[1][0].plot(t_TIME_PSSE, (t_F_SYS_PSSE+1)*50)
CurrentAx[1][1].plot(t_TIME_PSSE, t_Q_POC_PSSE)
...
CurrentAx[0][0].set_ylim([0.95, 1.15])
CurrentAx[0][1].set_ylim([0, 100])
CurrentAx[1][0].set_ylim([48, 52])
CurrentAx[1][1].set_ylim([-40, 30])
